...
namespace PizzaMVCApplication.Controllers
{
    public class SizeController : Controller
    {
        ...
        {
            var model = _sizeService.GetAll().Select(group => new SizeIndexViewModel
            {
                SizeId = group.SizeId,
        ...
        [HttpPost]
        public async Task<IActionResult> Create(SizeIndexViewModel model)
        {
            Size size = new Size
            {
                SizeId = model.SizeId,
        ...
        public IActionResult SearchModel(SizeSearchViewModel model)
        {
            ...
            var newModel = list.Select(group => new SizeIndexViewModel
            {
                SizeId = group.SizeId,
                Display = group.Display
            });
        ...
        {
            var group = _sizeService.GetById(SizeId);
        ...
        public async Task Delete(IList<SizeIndexViewModel> model)
        {
            ...
            await _sizeService.DeleteAsync(list);
        }
